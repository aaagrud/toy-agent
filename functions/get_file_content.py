...
schema_get_file_content = {
    ...
    "function": {
        ...
        "description": "Gets content of file in a specified file relative to the working directory, providing string contents of file.",
        "parameters": {
            "type": "object",
            "properties": {
                "file_path": {
                    "type": "string",
                    "description": "file path to get contents from, relative to the working directory (default is the working directory itself)",
                },
            },
        },
    },
